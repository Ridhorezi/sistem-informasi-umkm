...
Route::get('/umkm/data-pendaftar', [UMKMController::class, 'getDataPemilik'])->middleware('auth');

// Route::get('/umkm/data-pemilik', [UMKMController::class, 'getDataPemilik'])->middleware('auth');