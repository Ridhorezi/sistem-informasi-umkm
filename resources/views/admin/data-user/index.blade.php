...
@section('wrapper')
    ...
    <div class="main-pages">
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <a class="btn btn-primary" href="/tambah-data-user">Tambah</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 ">
                    <div class="card p-3 shadow">
                        <table id="tb-user" class="table table-striped dt-responsive nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>no</th>
                                    <th>name</th>
                            ...
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="d-inline" href="{{ route('editUser', ['id' => $data->id]) }}"
                                            ...
                                            <form id="hapus-form-{{ $data->id }}" class="form-inline"
                                                action="{{ route('hapusUser', ['id' => $data->id]) }}" method="post">
                                                @csrf
                                            </form>
                                        </td>
                                    </tr>
