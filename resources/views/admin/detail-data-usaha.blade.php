...
@section('wrapper')
    <div class="main-pages">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-12">
                    <h3 class="fw-bold">Detail Data Usaha</h3>
                </div>
            </div>
            ...
            <div class="row mb-2">
                <div class="col-md-3">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahModal"
                        data-bs-id="asset">Tambah Asset</button>
                </div>
            </div>
                                ...
                                @foreach ($datas as $data)
                                    @foreach ($data->assets as $aset)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="d-inline"
                                                    href="{{ route('editAsset', ['id' => $aset->id, 'id_usaha' => $id_usaha]) }}"
                                                    data-toggle="modal"><i class="fa fa-pencil-square-o fa-lg box-icon"
                                                        aria-hidden="true"></i></a>
                                                <button class="btn btn-icon btn-link p-0 btn-a mt-0"
                                                    onclick="showAlert3('asset', {{ $aset->id }})">
                                                    <i style="color: red" class="fa fa-trash fa-lg box-icon mb-2"
                                                        aria-hidden="true"></i>
                                                </button>

                                                <form id="hapus-asset-{{ $aset->id }}" class="form-inline"
                                                    action="{{ route('hapusAsset', ['id' => $aset->id]) }}" method="post">
                                                    @csrf
                                                </form>
                                            </td>
                                        </tr>
            ...
            <div class="row mb-2">
                <div class="col-md-3">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahModal"
                        data-bs-id="omset">Tambah Omset</button>
                </div>
            </div>
                                ...
                                @foreach ($datas as $data)
                                    @foreach ($data->funds as $omset)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="d-inline"
                                                    href="{{ route('editOmset', ['id' => $omset->id, 'id_usaha' => $id_usaha]) }}"
                                                    data-toggle="modal"><i class="fa fa-pencil-square-o fa-lg box-icon"
                                                        aria-hidden="true"></i></a>
                                                <button class="btn btn-icon btn-link p-0 btn-a mt-0"
                                                    onclick="showAlert3('omset', {{ $omset->id }})">
                                                    <i style="color: red" class="fa fa-trash fa-lg box-icon mb-2"
                                                        aria-hidden="true"></i>
                                                </button>

                                                <form id="hapus-omset-{{ $omset->id }}" class="form-inline"
                                                    action="{{ route('hapusOmset', ['id' => $omset->id]) }}"
                                                    method="post">
                                                    @csrf
                                                </form>
                                            </td>
            ...
            <div class="row mb-2">
                <div class="col-md-4">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahModal"
                        data-bs-id="tkerja">Tambah Tenaga Kerja</button>
                </div>
            </div>
            <div class="row mt-2 mb-4">
                <div class="col-12 ">
                                ...
                                @foreach ($datas as $data)
                                    @foreach ($data->workers as $worker)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="d-inline"
                                                    href="{{ route('editTkerja', ['id' => $worker->id, 'id_usaha' => $id_usaha]) }}"
                                                    data-toggle="modal"><i class="fa fa-pencil-square-o fa-lg box-icon"
                                                        aria-hidden="true"></i></a>
                                                <button class="btn btn-icon btn-link p-0 btn-a mt-0"
                                                    onclick="showAlert3('tkerja', {{ $worker->id }})">
                                                    <i style="color: red" class="fa fa-trash fa-lg box-icon mb-2"
                                                        aria-hidden="true"></i>
                                                </button>

                                                <form id="hapus-tkerja-{{ $worker->id }}" class="form-inline"
                                                    action="{{ route('hapusTkerja', ['id' => $worker->id]) }}"
                                                    method="post">
                                                    @csrf
                                                </form>
                                            </td>
            ...
            <div class="row mb-2">
                <div class="col-md-5">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahModal"
                        data-bs-id="kproduksi">Tambah Kapasitas Produksi</button>
                </div>
            </div>
            <div class="row mt-2 mb-4">
                <div class="col-12 ">
                                ...
                                @foreach ($datas as $data)
                                    @foreach ($data->capacityProductions as $c_productions)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="d-inline"
                                                    href="{{ route('editKproduksi', ['id' => $c_productions->id, 'id_usaha' => $id_usaha]) }}"
                                                    data-toggle="modal"><i class="fa fa-pencil-square-o fa-lg box-icon"
                                                        aria-hidden="true"></i></a>
                                                <button class="btn btn-icon btn-link p-0 btn-a mt-0"
                                                    onclick="showAlert3('kproduksi', {{ $c_productions->id }})">
                                                    <i style="color: red" class="fa fa-trash fa-lg box-icon mb-2"
                                                        aria-hidden="true"></i>
                                                </button>

                                                <form id="hapus-kproduksi-{{ $c_productions->id }}" class="form-inline"
                                                    action="{{ route('hapusKproduksi', ['id' => $c_productions->id]) }}"
                                                    method="post">
                                                    @csrf
                                                </form>
                                            </td>
