...
@section('wrapper')
    <div class="main-pages">
        <div class="container-fluid">
                ...
                <div class="card p-1 shadow card-data">
                    <div class="d-flex align-items-center px-4">
                        <div class="card-body text-end">
                            <h2 class="text-center fw-bold">Profile Settings</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            @endif
            <form class="row g-3" method="post" action="{{ route('editProfile', ['id' => $datas[0]->id]) }}">
                @csrf
                <div class="col-md-6">
                ...
                <div class="row mt-4">
                    <div class="row">
                        <div class="col-6 col-sm-5 col-md-3">
                            ...
                            <button id="tambah-data-umkm" class="btn btn-primary" type="submit">Edit Profile</button>
                        </div>
                    </div>
                </div>
            </form>
